document.addEventListener("DOMContentLoaded", () => {
    ...
    const CONFIG = window.WEDDING_CONFIG || {
        ...
        time: "7:00 PM",
        timerTarget: "2026-06-07T19:00:00+05:30",
        venue: "Y Convention, Vinukonda, Andhra Pradesh",
        youtubeId: "Hme-n3zBd9Y",
        ...
        eventId: 'd58408ac-eba7-4ed4-8b0a-c00ad3ead44d',
        eventType: 'Valima'
    };
    ...
    if (addToCalendarBtn) {
        addToCalendarBtn.addEventListener("click", () => {
            ...
            const startEndDates = "20260607T133000Z/20260607T163000Z";
            const details = encodeURIComponent("Join us live for the Valima celebration of Tummalagodu Ameer Basha & Shaik Mubeena Roshini. Live streaming links and wishes wall available on Eventcast.");
