// --- CONFIG ---
const WEDDING_DATE = new Date('April 12, 2026 19:30:00').getTime();
...
if (wishesForm) {
    wishesForm.addEventListener('submit', async (e) => {
        ...
        const { error } = await _supabase
            .from('wishes')
            .insert([{ name, message, event_id: 'naveen-lakshmi' }]);
...
// Real-time
_supabase.channel('public:wishes_naveen_lakshmi')
