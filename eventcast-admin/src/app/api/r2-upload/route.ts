...
export async function POST(req: NextRequest) {
  try {
    ...
    // ── Build public URL ──────────────────────────────────────────────────────
    // Format: https://pub-<hash>.r2.dev/<key>  (R2 public bucket URL)
    // Until you configure a custom domain, we use the r2.dev public URL.
    // Once cdn.eventcast.pro is set up, replace this with that domain.
    const publicBaseUrl = `https://${accountId}.r2.cloudflarestorage.com/${bucketName}`;
