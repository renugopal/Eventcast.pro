// --- CONFIG ---
const WEDDING_DATE = new Date('April 25, 2026 19:30:00').getTime();
...
if (wishesForm) {
    wishesForm.addEventListener('submit', async (e) => {
        ...
        const { error } = await _supabase
            .from('wishes')
            .insert([{ name, message, event_id: 'gayathri-vamsi' }]);
...
// Real-time
_supabase.channel('public:wishes_gayathri_vamsi')
