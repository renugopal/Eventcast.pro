// --- CONFIG ---
const WEDDING_DATE = new Date('April 29, 2026 09:00:00').getTime();
...
if (wishesForm) {
    wishesForm.addEventListener('submit', async (e) => {
        ...
        const { error } = await _supabase
            .from('wishes')
            .insert([{ name, message, event_id: 'raghavan-sowjanya' }]);
...
// Real-time
_supabase.channel('public:wishes_raghavan_sowjanya')
