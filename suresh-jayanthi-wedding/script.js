// --- CONFIG ---
const WEDDING_DATE = new Date('April 10, 2026 18:00:00').getTime();
...
if (wishesForm) {
    wishesForm.addEventListener('submit', async (e) => {
        ...
        const { error } = await _supabase
            .from('wishes')
            .insert([{ name, message, event_id: 'suresh-jayanthi' }]);
...
// Real-time
_supabase.channel('public:wishes_suresh_jayanthi')
